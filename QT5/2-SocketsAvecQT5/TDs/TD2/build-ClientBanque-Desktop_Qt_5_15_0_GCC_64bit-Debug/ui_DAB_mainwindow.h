...
public:
    ...
    void setupUi(QMainWindow *DAB_MainWindow)
    {
        ...
        layoutWidget = new QWidget(groupBox_Operations);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 40, 345, 112));
        gridLayout_2 = new QGridLayout(layoutWidget);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        gridLayout_2->setContentsMargins(0, 0, 0, 0);
        horizontalLayout_4 = new QHBoxLayout();
        horizontalLayout_4->setObjectName(QString::fromUtf8("horizontalLayout_4"));
        pushButton_NumCompte = new QPushButton(layoutWidget);
        ...
        lineEdit_NumCompte = new QLineEdit(layoutWidget);
        ...
        label_Montant = new QLabel(layoutWidget);
