...
public:
    ...
    void setupUi(QWidget *ServeurWidget)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 10, 258, 309));
        ...
        spinBox_NumPort = new QSpinBox(layoutWidget);
        ...
        pushButton_LancerServeur = new QPushButton(layoutWidget);
