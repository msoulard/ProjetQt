...
public:
    ...
    void setupUi(QWidget *Clavier)
    {
        ...
        Clavier->resize(418, 252);
        widget = new QWidget(Clavier);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(40, 40, 174, 24));
        ...
        widget1->setGeometry(QRect(40, 70, 340, 146));
        ...
        gridLayout->addWidget(pushButtonMarche, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(pushButtonArret, 5, 2, 1, 1);
